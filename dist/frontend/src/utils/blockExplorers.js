...
exports.getBlockExplorer = void 0;
var _1 = require(".");
var blockExplorers = {
...
var getBlockExplorer = function (address) {
    if (address === void 0) { address = ''; }
    var blockExplorerLink, blockExplorerName, chainName;
    if (address === null || address === void 0 ? void 0 : address.includes(':')) {
        var _a = __read(address.split(':'), 2), chain = _a[0], chainAddress = _a[1];
        var explorer = blockExplorers[chain];
        ...
        chainName = chain
            ? chain
                .split('_')
                .map(function (x) { return (0, _1.capitalizeFirstLetter)(x); })
                .join(' ')
            : 'Ethereum';
    }
    else {
    ...
    return {
        blockExplorerLink: blockExplorerLink !== null && blockExplorerLink !== void 0 ? blockExplorerLink : '',
        blockExplorerName: blockExplorerName !== null && blockExplorerName !== void 0 ? blockExplorerName : 'unknown',
        chainName: chainName
    };
};
