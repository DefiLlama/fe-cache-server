...
var YieldPageBorrow = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Filters_1.YieldFiltersV2, { header: "Yield Rankings", poolsNumber: poolsData.length, projectsNumber: selectedProjects.length, chainsNumber: selectedChains.length, tokens: tokens, tokensList: tokenSymbolsList, selectedTokens: includeTokens, chainList: chainList, selectedChains: selectedChains, projectList: projectList, selectedProjects: selectedProjects, attributes: true, resetFilters: true }), poolsData.length > 0 ? ((0, jsx_runtime_1.jsx)(Table_1.YieldsBorrowTable, { data: poolsData })) : ((0, jsx_runtime_1.jsx)(components_1.Panel, __assign({ as: "p", style: { margin: 0, textAlign: 'center' } }, { children: "Couldn't find any pools for these filters" })))] }));
};
exports.default = YieldPageBorrow;
