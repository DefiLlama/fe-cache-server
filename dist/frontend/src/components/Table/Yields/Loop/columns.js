...
exports.columns = [
    {
        ...
        cell: function (_a) {
            ...
            return ((0, jsx_runtime_1.jsx)(Name_1.NameYieldPool, { value: getValue(), configID: row.original.configID, url: row.original.url, index: index + 1, borrow: true, maxCharacters: 30 }));
        },
        size: 200
    },
    {
    ...
    },
    {
        ...
        cell: function (_a) {
            ...
            return ((0, jsx_runtime_1.jsxs)(Row_1.AutoRow, __assign({ sx: { width: '100%', justifyContent: 'flex-end', gap: '4px' } }, { children: [utils_3.lockupsRewards.includes(row.original.project) ? (0, jsx_runtime_1.jsx)(QuestionHelper_1.default, { text: utils_3.earlyExit }) : null, (0, jsx_runtime_1.jsx)(ColoredAPY_1.ColoredAPY, __assign({ "data-variant": "positive" }, { children: (0, utils_1.formattedPercent)(getValue(), true, 700) }))] })));
        },
        size: 140,
        meta: {
            align: 'end',
    ...
    },
    {
        ...
        enableSorting: true,
        cell: function (info) {
            return (0, jsx_runtime_1.jsx)(ColoredAPY_1.ColoredAPY, __assign({ "data-variant": "borrow" }, { children: (0, utils_1.toK)(info.getValue()) + 'x' }));
        },
        size: 140,
        meta: {
            align: 'end',
