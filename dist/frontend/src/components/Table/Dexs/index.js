...
exports.VolumeByChainsTable = exports.DexsTable = void 0;
...
function DexsTable(_a) {
    var data = _a.data;
    var _b = __read(React.useState([{ desc: true, id: 'totalVolume24h' }]), 2), sorting = _b[0], setSorting = _b[1];
    ...
    React.useEffect(function () {
        ...
        var order = windowSize.width
            ? (_b = (_a = columns_1.dexsTableColumnOrders.find(function (_a) {
...
exports.DexsTable = DexsTable;
function VolumeByChainsTable(_a) {
    var data = _a.data;
    var _b = __read(React.useState([{ desc: true, id: 'totalVolume' }]), 2), sorting = _b[0], setSorting = _b[1];
    var instance = (0, react_table_1.useReactTable)({
        data: data,
        columns: columns_1.volumesByChainsColumns,
        state: {
            sorting: sorting
        },
        onSortingChange: setSorting,
...
exports.VolumeByChainsTable = VolumeByChainsTable;
