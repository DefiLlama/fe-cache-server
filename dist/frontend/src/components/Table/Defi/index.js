...
exports.DefiChainsTable = void 0;
...
function DefiProtocolsTable(_a) {
...
exports.default = DefiProtocolsTable;
function DefiChainsTable(_a) {
    var data = _a.data;
    var _b = __read(React.useState([]), 2), sorting = _b[0], setSorting = _b[1];
    ...
    var instance = (0, react_table_1.useReactTable)({
        data: data,
        columns: columns_1.chainsColumn,
        state: {
            sorting: sorting,
            expanded: expanded,
    ...
    React.useEffect(function () {
        ...
        var order = windowSize.width
            ? (_b = (_a = columns_1.chainsTableColumnOrders.find(function (_a) {
...
exports.DefiChainsTable = DefiChainsTable;
