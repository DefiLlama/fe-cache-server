...
exports.PeggedAssetByChainTable = void 0;
...
function PeggedAssetByChainTable(_a) {
    var data = _a.data;
    var _b = __read(React.useState([{ id: 'circulating', desc: true }]), 2), sorting = _b[0], setSorting = _b[1];
    ...
    var instance = (0, react_table_1.useReactTable)({
        data: data,
        columns: columns_1.peggedAssetByChainColumn,
        state: {
            sorting: sorting,
            expanded: expanded,
    ...
    React.useEffect(function () {
        ...
        var order = windowSize.width
            ? (_b = (_a = columns_1.assetByChainColumnOrders.find(function (_a) {
...
exports.PeggedAssetByChainTable = PeggedAssetByChainTable;
