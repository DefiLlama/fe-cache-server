...
exports.PeggedAssetsTable = void 0;
...
function PeggedAssetsTable(_a) {
    ...
    var instance = (0, react_table_1.useReactTable)({
        data: data,
        columns: columns_1.peggedAssetsColumn,
        state: {
            sorting: sorting,
    ...
    React.useEffect(function () {
        ...
        var order = windowSize.width
            ? (_b = (_a = columns_1.assetsColumnOrders.find(function (_a) {
...
exports.PeggedAssetsTable = PeggedAssetsTable;
