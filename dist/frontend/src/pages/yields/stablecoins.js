...
exports.getStaticProps = (0, perf_1.withPerformanceLogging)('yields/stablecoins', function () { return __awaiter(void 0, void 0, void 0, function () {
...
function YieldPlots(data) {
    return ((0, jsx_runtime_1.jsxs)(layout_1.default, __assign({ title: "Stablecoins - DefiLlama Yield", defaultSEO: true }, { children: [(0, jsx_runtime_1.jsx)(Announcement_1.default, { children: utils_1.disclaimer }), (0, jsx_runtime_1.jsx)(YieldsPage_1.default, __assign({}, data))] })));
}
