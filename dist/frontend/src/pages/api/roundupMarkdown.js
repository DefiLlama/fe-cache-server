...
function roundupMarkdown(req, res) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var headers, data, index, raw, messages, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    data = _b.sent();
                    index = (_a = data.findIndex(function (d) { return d.content.startsWith('Daily news round-up with the'); })) !== null && _a !== void 0 ? _a : null;
...
exports.default = roundupMarkdown;
