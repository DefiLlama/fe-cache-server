...
var MyDocument = /** @class */ (function (_super) {
                    ...
                    case 1:
                        ...
                        ctx.renderPage = function () {
                            return originalRenderPage({
                                enhanceApp: function (App) { return function (props) { return sheet.collectStyles((0, jsx_runtime_1.jsx)(App, __assign({}, props))); }; }
                            });
                        };
                        return [4 /*yield*/, document_1.default.getInitialProps(ctx)];
                    case 2:
                        initialProps = _a.sent();
                        return [2 /*return*/, __assign(__assign({}, initialProps), { styles: [initialProps.styles, sheet.getStyleElement()] })];
                    case 3:
                        sheet.seal();
                        return [7 /*endfinally*/];
    ...
    MyDocument.prototype.render = function () {
        return ((0, jsx_runtime_1.jsxs)(document_1.Html, __assign({ lang: "en" }, { children: [(0, jsx_runtime_1.jsx)(document_1.Head, { children: (0, jsx_runtime_1.jsx)("link", { href: "https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;800&display=swap", rel: "stylesheet" }) }), (0, jsx_runtime_1.jsxs)("body", { children: [(0, jsx_runtime_1.jsx)(document_1.Main, {}), (0, jsx_runtime_1.jsx)(document_1.NextScript, {})] })] })));
    };
    return MyDocument;
}(document_1.default));
