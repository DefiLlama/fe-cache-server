...
exports.getStaticProps = (0, perf_1.withPerformanceLogging)('forks', function () { return __awaiter(void 0, void 0, void 0, function () {
    var data;
...
var PageView = function (_a) {
    var chartData = _a.chartData, tokensProtocols = _a.tokensProtocols, tokens = _a.tokens, tokenLinks = _a.tokenLinks, parentTokens = _a.parentTokens, forkColors = _a.forkColors;
    var forkedTokensData = (0, data_1.useCalcStakePool2Tvl)(parentTokens);
    ...
    var _c = React.useMemo(function () {
        ...
        var tokensList = tvls.map(function (_a) {
            ...
            var tokenTvl = (_c = (_b = forkedTokensData.find(function (p) { return p.name.toLowerCase() === name.toLowerCase(); })) === null || _b === void 0 ? void 0 : _b.tvl) !== null && _c !== void 0 ? _c : null;
            var ftot = tokenTvl ? (value / tokenTvl) * 100 : null;
            return {
                name: name,
    ...
    }, [chainsWithExtraTvlsByDay, tokensProtocols, forkedTokensData]), tokenTvls = _c.tokenTvls, tokensList = _c.tokensList;
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Search_1.ProtocolsChainsSearch, { step: { category: 'Home', name: 'Forks' } }), (0, jsx_runtime_1.jsx)(Theme_1.Header, { children: "Total Value Locked All Forks" }), (0, jsx_runtime_1.jsxs)(ChartsWrapper, { children: [(0, jsx_runtime_1.jsx)(PieChart, { chartData: tokenTvls, stackColors: forkColors }), (0, jsx_runtime_1.jsx)(AreaChart, { chartData: chainsWithExtraTvlsAndDominanceByDay, stacks: tokens, stackColors: forkColors, customLegendName: "Fork", customLegendOptions: tokens, hideDefaultLegend: true, valueSymbol: "%", title: "", expandTo100Percent: true })] }), (0, jsx_runtime_1.jsx)(Filters_1.RowLinksWrapper, { children: (0, jsx_runtime_1.jsx)(Filters_1.RowLinksWithDropdown, { links: tokenLinks, activeLink: "All" }) }), (0, jsx_runtime_1.jsx)(TableWithSearch_1.TableWithSearch, { data: tokensList, columns: columns_1.forksColumn, placeholder: 'Search protocols...', columnToSearch: 'name' })] }));
};
