...
exports.getStaticProps = (0, perf_1.withPerformanceLogging)('oracles/[oracle]', function (_a) {
    var oracle = _a.params.oracle;
    return __awaiter(void 0, void 0, void 0, function () {
        var data;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, protocols_1.getOraclePageData)(oracle)];
                case 1:
                    data = _b.sent();
...
function getStaticPaths() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, oracles, oraclesList, paths;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, protocols_1.getOraclePageData)()];
                case 1:
                    _a = (_b.sent()).oracles, oracles = _a === void 0 ? {} : _a;
                    oraclesList = Object.keys(oracles);
                    paths = oraclesList.slice(0, 10).map(function (oracle) {
                        return {
...
var PageView = function (_a) {
    var _b, _c;
    var chartData = _a.chartData, tokenLinks = _a.tokenLinks, token = _a.token, filteredProtocols = _a.filteredProtocols;
    ...
    var _e = (0, react_1.useMemo)(function () {
        ...
        var finalChartData = (0, data_1.formatChartTvlsByDay)({ data: chartData, extraTvlsEnabled: extraTvlsEnabled, key: 'TVS' });
        var totalVolume = (0, utils_1.getPrevTvlFromChart2)(finalChartData, 0, 'TVS');
        var tvlPrevDay = (0, utils_1.getPrevTvlFromChart2)(finalChartData, 1, 'TVS');
        var volumeChangeUSD = (0, utils_1.getPercentChange)(totalVolume, tvlPrevDay);
        return { protocolsData: protocolsData, finalChartData: finalChartData, totalVolume: totalVolume, volumeChangeUSD: volumeChangeUSD };
    }, [chartData, extraTvlsEnabled, filteredProtocols]), protocolsData = _e.protocolsData, finalChartData = _e.finalChartData, totalVolume = _e.totalVolume, volumeChangeUSD = _e.volumeChangeUSD;
    var topToken = {};
    ...
    var tvs = (0, utils_1.formattedNum)(totalVolume, true);
