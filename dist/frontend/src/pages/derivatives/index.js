...
exports.type = types_1.ADAPTOR_TYPES.DERIVATIVES;
var perf_1 = require("../../utils/perf");
exports.getStaticProps = (0, perf_1.withPerformanceLogging)('derivatives/index', (0, _type_1.getStaticPropsByType)(exports.type));
